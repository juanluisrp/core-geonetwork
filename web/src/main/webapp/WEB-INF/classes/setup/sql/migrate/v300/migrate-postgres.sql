...
-- NGR 2 has already these elements
...
UPDATE Settings SET name = 'system/inspire/atom' WHERE name = 'atom';
UPDATE Settings SET name = 'system/inspire/atomSchedule' WHERE name = 'atomSchedule';
UPDATE Settings SET name = 'system/inspire/atomProtocol' WHERE name = 'atomProtocol';
