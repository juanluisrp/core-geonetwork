(function() {
  ...
  goog.provide('gn_search_geodatastore_directive');

  var module = angular.module('gn_search_geodatastore_directive', []);
  ...
  module.directive('gnInfoList', ['gnMdView',
    function(gnMdView) {
      return {
        restrict: 'A',
        replace: true,
        templateUrl: '../../catalog/views/geodatastore/directives/' +
